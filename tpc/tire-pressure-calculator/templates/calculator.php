...
<div class="tool-header">
  ...
  <p>presented by Rene Herse Cycles and Cal Poly Pomona</p>
</div>
    ...
    <div class="two-col">
      <div class="field">
        ...
        <select id="rhc-p-bikestyle">
          <option value="40/60">Road bike</option>
          <option value="40/60g">Gravel bike</option>
          <option value="38/62">Touring bike</option>
          <option value="35/65">City bike</option>
        </select>
      </div>
      <div class="field">
        ...
        <select id="rhc-p-position">
          ...
          <option value="low" selected>Low / stretched-out</option>
  ...
  <div class="panel-inner">
    ...
    <div class="field">
      ...
      <select id="rhc-f-style">
        ...
        <option value="allroad">All-Road — mixed surfaces</option>
        <option value="gravel">Gravel — dirt roads</option>
